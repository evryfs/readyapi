...
ENV READYAPI_VERSION=2.4.0 READYAPI_LICENSE_MANAGER_VERSION=1.2.2 LICENSE_SERVER=fslicense.evry.com:1099
...
RUN apt-get update && apt-get install -y openjfx wget && \
	...
	mv ready-api-license-manager-${READYAPI_LICENSE_MANAGER_VERSION}.jar ready-api-license-manager.jar && \
